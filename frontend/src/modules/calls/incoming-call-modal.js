...
function show(call) {
  ...
  console.log('📞 Incoming call modal:', call);
  ...
  modal.innerHTML = `
    <div class="modal incoming-call-modal-content">
      <div class="incoming-call-header">
        ...
        <h2>Incoming ${call.callType} call</h2>
...
function setupEventListeners(modal) {
  ...
  answerBtn.addEventListener('click', async () => {
    ...
    try {
      ...
      // ✅ ИСПРАВЛЕНО: Добавляем targetUserId = initiatorId
      ActiveCallWindow.show({
        ...
        isConference: false,
        targetUserId: currentCall.initiatorId, // ✅ ДОБАВЛЕНО
      }, false); // false = не инициатор
